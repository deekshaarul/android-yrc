...
public class DonorMain extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView match = (TextView) findViewById(R.id.md);

        match.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(getApplicationContext(), MatchDonor.class);
                startActivity(i);
            }
        });

        TextView update = (TextView) findViewById(R.id.ud);
        update.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(getApplicationContext(), UpdateDonor.class);
                startActivity(i);
            }
        });
    ...
    public void onBackPressed() {
        ...
        if (drawer.isDrawerOpen(GravityCompat.START)) {
            ...
            super.onBackPressed();
            startActivity(new Intent(DonorMain.this, MainActivity.class));
            finish();
        }
    }
